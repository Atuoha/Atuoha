...
Senior Mobile & AI Software Engineer specializing in Flutter/Dart, Kotlin (Jetpack Compose), AI, and Swift (UIKit/SwiftUI), with a comprehensive background in web technologies. Skilled in designing, developing, and deploying software for Android, iOS, Web, and other platforms. Adept at collaborating effectively with cross-functional teams to create high-quality, scalable products.
